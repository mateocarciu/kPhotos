    ...
    <UCard>
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <UButton v-if="!isEditing" color="primary" icon="i-heroicons-pencil-square" @click="isEditing = true"> Edit </UButton>
        </div>
      </template>
      ...
      <div class="space-y-8">
        ...
        <div>
          ...
          <!-- Edit Form -->
          <div v-else>
            <UForm :state="form" class="grid gap-6 md:grid-cols-2">
              <div class="space-y-4">
          ...
          <UCard>
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <UButton size="sm" color="neutral" variant="ghost" icon="i-heroicons-key"> Change </UButton>
              </div>
              ...
              <div class="flex items-center justify-between">
                ...
                <UButton size="sm" color="neutral" variant="ghost" icon="i-heroicons-document-duplicate"> Generate </UButton>
              </div>
            </div>
          </UCard>
        </div>
...
const updateProfile = async () => {
  ...
  try {
    ...
    toast.add({
      title: 'Error',
      description: 'Unable to update your profile' + (error instanceof Error ? error.message : ''),
      color: 'error'
    })
  } finally {
